                ...
                <div class="bg-light rounded-4 py-5 px-4 px-md-5">
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-lg-8 col-xl-6">
                            ...
                            <!-- to get an API token!-->
                            <form action="../actions/actions.php" method="POST"  data-sb-form-api-token="API_TOKEN">
                                <!-- Name input-->
                                ...
                                <!-- Email address input-->
                                <div class="form-floating mb-3">
                                    <input class="form-control"  name="address" type="email" placeholder="name@example.com" data-sb-validations="required,email" />
